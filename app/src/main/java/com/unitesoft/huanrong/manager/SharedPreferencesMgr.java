package com.unitesoft.huanrong.manager;
...
public class SharedPreferencesMgr {
     ...
     * @param shipan
     */
    public static  void isShipan(boolean shipan){
        if(sPrefs ==null)
            return ;
        SharedPreferences.Editor editor = sPrefs.edit();
        editor.putBoolean("shipan", shipan);
        editor.commit();
    }
    public static  boolean getShipan(){
        return sPrefs.getBoolean("shipan",false);
    }
}
