...
public class ProgressHelper {
    private com.unitesoft.huanrong.widget.view.sweetdialog.ProgressWheel mProgressWheel;
    ...
    public com.unitesoft.huanrong.widget.view.sweetdialog.ProgressWheel getProgressWheel () {
        return mProgressWheel;
    }

    public void setProgressWheel (com.unitesoft.huanrong.widget.view.sweetdialog.ProgressWheel progressWheel) {
