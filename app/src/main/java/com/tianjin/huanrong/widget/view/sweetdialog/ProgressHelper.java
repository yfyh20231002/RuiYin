package com.tianjin.huanrong.widget.view.sweetdialog;
...
public class ProgressHelper {
    private com.tianjin.huanrong.widget.view.sweetdialog.ProgressWheel mProgressWheel;
    ...
    public com.tianjin.huanrong.widget.view.sweetdialog.ProgressWheel getProgressWheel () {
        return mProgressWheel;
    }

    public void setProgressWheel (com.tianjin.huanrong.widget.view.sweetdialog.ProgressWheel progressWheel) {
