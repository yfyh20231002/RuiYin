package com.example.shichang393.ruiyin.widget.view.sweetdialog;
...
public class SuccessTickView extends View {
    ...
    public void startTickAnim () {
        ...
        mRightRectWidth = 0;
        invalidate();
        final Animation tickAnim = new Animation() {
            @Override
        ...
        tickAnim.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                if (null != mTickOverListener){
                    mTickOverListener.tickOver();
                }
            }
    ...
    private TickOverListener mTickOverListener;
